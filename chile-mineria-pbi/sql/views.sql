CREATE VIEW IF NOT EXISTS vw_produccion_trimestral AS
SELECT
  t.anio,
  t.trimestre,
  t.periodo_inicio,
...
CREATE VIEW IF NOT EXISTS vw_financiero_trimestral AS
SELECT
  t.anio,
  t.trimestre,
  t.periodo_inicio,
...
CREATE VIEW IF NOT EXISTS vw_glosario_metricas AS
SELECT
  codigo,
  nombre,
  unidad,
